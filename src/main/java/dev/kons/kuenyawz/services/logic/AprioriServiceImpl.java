...
public class AprioriServiceImpl implements AprioriService {
	...
	@Override
	public Map<Long, Set<Long>> findFrequentSetItemWith(Map<Long, Set<Long>> orders, Long productId) {
		return findFrequentSetItemWith(orders, productId, Integer.MAX_VALUE);
	}

	@Override
	public Map<Long, Set<Long>> findFrequentSetItemWith(Map<Long, Set<Long>> orders, Long productId, int topN) {
	...
	@Override
	public Map<Long, Set<Long>> getTopN(Map<Long, Set<Long>> orders, int topN) {
		...
		for (Long productId : topItems) {
			result.put(productId, new HashSet<>(topItems));
		}
